...
import { propParseService, FormattedPropertyData, parseMainProperty, PropertyDetails } from '@/features/api/services/propParse';
      ...
      <div className="px-3 sm:px-4 lg:px-6 py-2 border-b border-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          {parsedData.squareFeet && (
            <div className="bg-gray-50 p-2 rounded">
              <h4 className="text-xs font-medium text-gray-500 mb-0.5">Square Feet</h4>
              <p className="text-lg font-semibold text-gray-900">
        ...
        <div className="bg-orange-50 border border-orange-200 rounded p-3 sm:p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <div>
              ...
              <div className="mt-1 text-orange-700 bg-orange-100 px-2 py-1 rounded">
                {apiName || 'N/A'}
              </div>
            </div>
            <div>
