...
import { sessionStorageService, SessionData } from '../services/sessionStorage';
      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-8 py-3 sm:py-4 lg:py-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0 sm:space-x-3">
          ...
          <div className="flex-1 min-w-0">
            {isEditing ? (
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="text-lg sm:text-xl font-bold text-gray-900 bg-transparent border-b-2 border-[#1dd1f5] focus:outline-none focus:border-[#014463] min-w-0 flex-1 text-left"
                  autoFocus
                />
                <button
              ...
              <div className="flex items-center space-x-2 group">
                <h1 className="text-lg sm:text-xl font-bold text-gray-900 truncate text-left">
                  {sessionData.name}
                </h1>
                <button
                  onClick={handleStartEdit}
                  className="opacity-0 group-hover:opacity-100 p-1 text-gray-400 hover:text-[#1dd1f5] hover:bg-[#1dd1f5]/10 rounded transition-all flex-shrink-0"
            ...
            <div className="flex items-center space-x-3 mt-1 text-xs text-gray-500 sm:hidden">
          ...
          <div className="flex items-center justify-start sm:justify-end space-x-2 flex-shrink-0">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-2.5 sm:px-3 py-1.5 text-xs sm:text-sm font-medium text-white bg-[#1dd1f5] border border-[#1dd1f5] rounded-md hover:bg-[#1bc4e8] focus:outline-none focus:ring-2 focus:ring-[#1dd1f5] focus:border-[#1dd1f5] transition-colors touch-manipulation"
            >
        ...
        {/* Desktop: Timestamps */}
        <div className="hidden sm:flex items-center space-x-6 mt-3 text-sm text-gray-500">
          <div className="flex items-center space-x-2">
