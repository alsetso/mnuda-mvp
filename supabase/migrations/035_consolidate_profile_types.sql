-- Consolidate profile_type enum to 4 types: homeowner, realtor, wholesaler, investor
-- Remove: renter, contractor, services, developer, property_manager, organization

-- ============================================================================
-- STEP 1: Create new consolidated profile_type enum
-- ============================================================================
...
-- ============================================================================
-- STEP 3: Migrate data - map removed types to closest match
-- ============================================================================

-- Profiles: Map removed types to homeowner (default) or closest match
UPDATE public.profiles
SET profile_type_temp = CASE
  WHEN profile_type::text IN ('homeowner', 'realtor', 'wholesaler', 'investor') 
    THEN profile_type::text::public.profile_type_new
  WHEN profile_type::text = 'renter' THEN 'homeowner'::public.profile_type_new
  WHEN profile_type::text = 'contractor' THEN 'homeowner'::public.profile_type_new
  WHEN profile_type::text = 'services' THEN 'homeowner'::public.profile_type_new
  WHEN profile_type::text = 'developer' THEN 'investor'::public.profile_type_new
  WHEN profile_type::text = 'property_manager' THEN 'realtor'::public.profile_type_new
  WHEN profile_type::text = 'organization' THEN 'investor'::public.profile_type_new
  ELSE 'homeowner'::public.profile_type_new
END;

-- Onboarding questions: Map removed types to homeowner (default)
...
COMMENT ON TYPE public.profile_type IS 'Profile type enum: homeowner, realtor, wholesaler, investor';
COMMENT ON COLUMN public.profiles.profile_type IS 'Profile type: homeowner, realtor, wholesaler, investor';
